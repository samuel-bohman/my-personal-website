...
The complement to the Jaccard index is the Jaccard distance and it measures dissimilarity between binary vectors: 
...
### Example 
Assume we have two vectors A and B in a data frame along 6 dimensions: 
...
To calculate the Jaccard similarity we use the following formula: 
